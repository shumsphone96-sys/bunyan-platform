(()=>{
  'use strict';
  const release='20260731-executive-v9-2';
  ...
  addStyle('volunteers-v8.css','volunteers-v8');
  addStyle('executive-dashboard-v9.css','executive-dashboard-v9');
  addScript('project-v4.js','project-v4',()=>{
    ...
    addScript('volunteers-v8.js','volunteers-v8');
    addScript('executive-dashboard-v9.js','executive-dashboard-v9');
  });
})();