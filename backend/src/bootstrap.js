...
source=source.replaceAll("version:'8.0.0'","version:'10.0.0'").replaceAll('BUNYAN Cloud API 8.0.0','BUNYAN Cloud API 10.0.0');
...
source=source.replace(
  ...
  "p.cover_image_url,p.location,p.latitude,p.longitude,p.created_at"
);
source=source.replace(
  "'start_date','end_date','is_public']}",
  "'start_date','end_date','latitude','longitude','is_public']}"
);
