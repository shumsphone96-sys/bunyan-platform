const C='bunyan-v14-official-domain';
...
self.addEventListener('fetch',event=>{
  if(event.request.url.startsWith('https://api.bunyan-sudan.org')||event.request.url.startsWith('https://bunyan-api-qhkf.onrender.com'))return;
