const C='bunyan-v10-global-operations';
const ASSETS=['./','./index.html','./styles.css','./workflow.css','./auth-center.css','./global-upgrade.css','./app.js','./workflow.js','./auth-center.js','./donation-receipt.js','./global-upgrade.js','./manifest.json'];
